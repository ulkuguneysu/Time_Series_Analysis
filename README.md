...
$$ \text{ROI} =  \frac{\text{GAIN ON INVESTMENT − COST OF INVESTMENT}}{\text{COST OF INVESTMENT}} $$
...
$$ \text{ROI(%)} = \frac{\text{RETURN ON INVESTMENT}}{\text{COST OF INVESTMENT}} * 100 $$

Calculate risk factor for each zipcode using lower confidence interval.

<img src="Images/risk.png">
$$ \text{Risk(%)} = \frac{\text{COST OF INVESTMENT - LOWER PREDICTION}}{\text{COST OF INVESTMENT}} * 100 $$
